class View:
    def greeting(self):
        print("Здравствуйте! Вы запустили приложение для управления заметками!")

    def show_main_menu(self):
        print("Для продолжения работы выберете нужную функцию:\n"
              "\t1. Добавить заметку\n"
    ...
    def error(self):
        print("Вышла ошибочка! Введите правельное число")
    def not_found(self):
